...
const BlogsSection = () => {
  return (
    <section id="blogs" className="py-24 bg-gradient-to-b from-tech-dark to-tech-darker">
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 opacity-0 animate-slide-up animate-delay-200">
          {blogPosts.map((blog) => (
            <BlogCard key={blog.id} blog={blog} />
          ))}
        </div>
        
        <div className="mt-12 text-center opacity-0 animate-slide-up animate-delay-300">
          <a 
